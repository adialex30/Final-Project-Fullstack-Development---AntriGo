...
const NAV_ITEMS = [
  ...
  { to: '/admin/board', label: 'Papan Dapur', roles: ['STAFF'] },
  { to: '/admin/products', label: 'Produk & Stok', roles: ['ADMIN'] },
  { to: '/admin/reports', label: 'Laporan', roles: ['ADMIN'] },
  { to: '/admin/register-staff', label: 'Registrasi Staff', roles: ['ADMIN'] },
]
